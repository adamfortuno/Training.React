...
var OptionEntry = function (_React$Component5) {
    _inherits(OptionEntry, _React$Component5);

    function OptionEntry(props) {
        _classCallCheck(this, OptionEntry);

        var _this5 = _possibleConstructorReturn(this, (OptionEntry.__proto__ || Object.getPrototypeOf(OptionEntry)).call(this, props));

        _this5.optionAdd = _this5.optionAdd.bind(_this5);
