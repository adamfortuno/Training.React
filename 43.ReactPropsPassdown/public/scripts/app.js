    ...
    _createClass(Self, [{
        ...
        value: function optionRemove(optionTarget) {
            ...
            this.setState(function (ps) {
                return {
                    options: ps.options.filter(function (e) {
                        return e !== optionTarget;
                    })
                };
            });
        }
        ...
        value: function optionAdd(newOption) {
            ...
            this.setState(function (ps) {
                return { options: ps.options.concat(newOption) };
            });
        }
    }, {
        key: 'render',
...
var Options = function Options(props) {
    ...
    return React.createElement(
        ...
        options.map(function (opt) {
            return React.createElement(Option, { key: opt, option: opt, optionRemove: props.optionRemove });
        })
    );
};
