...
import { isAdult, canDrink} from './exportExplicit.js';
import minus, { add } from './exportObject.js';
...
console.log('Is An Adult: ', isAdult(age));
console.log('Can Legally Drink: ', canDrink(age));
s
console.log('Adding: ', add(1, 2));
console.log('Subtract: ', minus(1, 2));
